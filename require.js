    ...
    function newContext(e) {
        function t(e, t, i) {
            var r, n, o, a, s, u, c, d, p, f, l = t && t.split("/"),
                h = w.map,
                m = h && h["*"];
            if (e && (u = (e = e.split("/")).length - 1, w.nodeIdCompat && jsSuffixRegExp.test(e[u]) && (e[u] = e[u].replace(jsSuffixRegExp, "")), "." === e[0].charAt(0) && l && (e = l.slice(0, l.length - 1).concat(e)), function(e) {
                    var t, i;
        ...
        function o(e, i, r, o) {
            var a, s, u, c, d = null,
                ...
                l = !0,
                h = "";
            return e || (l = !1, e = "_@r" + (R += 1)), d = (c = n(e))[0], e = c[1], d && (d = t(d, p, o), s = getOwn(O, d)), e && (d ? h = s && s.normalize ? s.normalize(e, (function(e) {
                return t(e, p, o)
            })) : -1 === e.indexOf("!") ? t(e, p, o) : e : (d = (c = n(h = t(e, p, o)))[0], h = c[1], r = !0, a = b.nameToUrl(h))), {
                prefix: d,
                name: h,
                parentMap: i,
                unnormalized: !!(u = !d || s || r ? "" : "_unnormalized" + (T += 1)),
                url: a,
                originalName: f,
                isDefine: l,
                id: (d ? d + "!" + h : h) + u
        ...
        function a(e) {
            var t = e.id,
                i = getOwn(y, t);
            return i || (i = y[t] = new b.Module(e)), i
        }

        function s(e, t, i) {
            var r = e.id,
                n = getOwn(y, r);
            !hasProp(O, r) || n && !n.defineEmitComplete ? (n = a(e)).error && "error" === t ? i(n.error) : n.on(t, i) : "defined" === t && i(O[r])
        }
        ...
        function c() {
            globalDefQueue.length && (each(globalDefQueue, (function(e) {
                var t = e[0];
                "string" == typeof t && (b.defQueueMap[t] = !0), M.push(e)
            })), globalDefQueue = [])
        }
        ...
        function p(e, t, i) {
            ...
            e.error ? e.emit("error", e.error) : (t[r] = !0, each(e.depMaps, (function(r, n) {
                var o = r.id,
                    a = getOwn(y, o);
                !a || e.depMatched[n] || i[o] || (getOwn(t, o) ? (e.defineDep(n, O[o]), e.check()) : p(a, t, i))
            })), i[r] = !0)
        }

        function f() {
            var e, t, n = 1e3 * w.waitSeconds,
            ...
            if (!v) {
                if (v = !0, eachProp(S, (function(e) {
                    ...
                    })), o && a.length) return (e = makeError("timeout", "Load timeout for modules: " + a, null, a)).contextName = b.contextName, u(e);
                d && each(s, (function(e) {
                    p(e, {}, {})
        ...
        function l(e) {
            hasProp(O, e[0]) || a(o(e[0], null, !0)).init(e[1], e[2])
        }
        ...
        function m(e) {
            ...
            return h(t, b.onScriptLoad, "load", "onreadystatechange"), h(t, b.onScriptError, "error"), {
                node: t,
        ...
        function g() {
            var e;
            for (c(); M.length;) {
                if (null === (e = M.shift())[0]) return u(makeError("mismatch", "Mismatched anonymous define() module: " + e[e.length - 1]));
                l(e)
            }
            b.defQueueMap = {}
        }
        ...
        return q = {
                    ...
                    if (this.inited) {
                        if (this.error) this.emit("error", this.error);
                            ...
                            if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                ...
                                if (this.exports = n, this.map.isDefine && !this.ignore && (O[i] = n, req.onResourceLoad)) {
                                    var a = [];
            ...
            callPlugin: function() {
                ...
                this.depMaps.push(r), s(r, "defined", bind(this, (function(r) {
                    var n, c, p, f = getOwn(P, this.map.id),
                        l = this.map.name,
                    ...
                    return this.map.unnormalized ? (r.normalize && (l = r.normalize(l, (function(e) {
                    ...
                    }))), void((p = getOwn(y, c.id)) && (this.depMaps.push(c), this.events.error && p.on("error", bind(this, (function(e) {
                        this.emit("error", e)
                    }))), p.enable()))) : f ? (this.map.url = b.nameToUrl(f), void this.load()) : (n = bind(this, (function(e) {
                        this.init([], (function() {
                            return e
                        }), null, {
                            enabled: !0
                        ...
                        this.inited = !0, this.error = e, e.requireModules = [i], eachProp(y, (function(e) {
                        ...
                        var s = e.name,
                            c = o(s),
                            d = useInteractive;
                        r && (t = r), d && (useInteractive = !1), a(c), hasProp(w.config, i) && (w.config[s] = w.config[i]);
                        try {
                            req.exec(t)
                        } catch (e) {
                            return u(makeError("fromtexteval", "fromText eval for " + i + " failed: " + e, e, [i]))
                        }
                        d && (useInteractive = !0), this.depMaps.push(c), b.completeLoad(s), m([s], n)
            ...
            enable: function() {
                S[this.map.id] = this, this.enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, (function(e, t) {
                    var i, r, n;
                    if ("string" == typeof e) {
                        if (e = o(e, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.skipMap), this.depMaps[t] = e, n = getOwn(q, e.id)) return void(this.depExports[t] = n(this));
                    ...
                    i = e.id, r = y[i], hasProp(q, i) || !r || r.enabled || b.enable(e, this)
            ...
            configure: function(e) {
                ...
                eachProp(e, (function(e, t) {
                    ...
                    isArray(e) && (e = {
                        deps: e
                    }), !e.exports && !e.init || e.exportsFn || (e.exportsFn = b.makeShimExports(e)), i[t] = e
            ...
            makeRequire: function(r, n) {
                function s(t, i, c) {
                    var d, p;
                    return n.enableBuildCallback && i && isFunction(i) && (i.__requireJsBuild = !0), "string" == typeof t ? isFunction(i) ? u(makeError("requireargs", "Invalid require call"), c) : r && hasProp(q, t) ? q[t](y[r.id]) : req.get ? req.get(b, t, r, s) : (d = o(t, r, !1, !0).id, hasProp(O, d) ? O[d] : u(makeError("notloaded", 'Module name "' + d + '" has not been loaded yet for context: ' + e + (r ? "" : ". Use require([])")))) : (g(), b.nextTick((function() {
                        g(), (p = a(o(null, r))).skipMap = n.skipMap, p.init(t, i, c, {
                            enabled: !0
                        }), f()
                    })), s)
                }
                return n = n || {}, mixin(s, {
                    ...
                    toUrl: function(e) {
                        var i, n = e.lastIndexOf("."),
                            o = e.split("/")[0];
                        return -1 !== n && (!("." === o || ".." === o) || n > 1) && (i = e.substring(n, e.length), e = e.substring(0, n)), b.nameToUrl(t(e, r && r.id, !0), i, !0)
                    },
                    defined: function(e) {
                        return hasProp(O, o(e, r, !1, !0).id)
                    },
                    specified: function(e) {
                        return e = o(e, r, !1, !0).id, hasProp(O, e) || hasProp(y, e)
                    }
                }), r || (s.undef = function(e) {
                    c();
                    var t = o(e, r, !0),
                        n = getOwn(y, e);
                    n.undefed = !0, i(e), delete O[e], delete j[t.url], delete k[e], eachReverse(M, (function(t, i) {
                        t[0] === e && M.splice(i, 1)
                    })), delete b.defQueueMap[e], n && (n.events.defined && (k[e] = n.events), d(e))
                }), s
            },
            enable: function(e) {
                getOwn(y, e.id) && a(e).enable()
            },
            completeLoad: function(e) {
                var t, i, n, o = getOwn(w.shim, e) || {},
                    a = o.exports;
                for (c(); M.length;) {
                    if (null === (i = M.shift())[0]) {
                        if (i[0] = e, t) break;
                ...
                if (b.defQueueMap = {}, n = getOwn(y, e), !t && !hasProp(O, e) && n && !n.inited) {
                    if (!(!w.enforceDefine || a && getGlobal(a))) return r(e) ? void 0 : u(makeError("nodefine", "No define call for " + e, null, [e]));
                    l([e, o.deps || [], o.exportsFn])
                }
                f()
            },
            nameToUrl: function(e, t, i) {
                var r, n, o, a, s, u, c = getOwn(w.pkgs, e);
                if (c && (e = c), u = getOwn(P, e)) return b.nameToUrl(u, t, i);
                if (req.jsExtRegExp.test(e)) a = e + (t || "");
                else {
                    for (r = w.paths, o = (n = e.split("/")).length; o > 0; o -= 1)
                        if (s = getOwn(r, n.slice(0, o).join("/"))) {
                            isArray(s) && (s = s[0]), n.splice(0, o, s);
                            break
                        } a = n.join("/"), a = ("/" === (a += t || (/^data\:|^blob\:|\?/.test(a) || i ? "" : ".js")).charAt(0) || a.match(/^[\w\+\.\-]+:/) ? "" : w.baseUrl) + a
                }
            ...
            onScriptError: function(e) {
                ...
                if (!r(t.id)) {
                    var i = [];
                    return eachProp(y, (function(e, r) {
