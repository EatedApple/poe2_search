...
if (function(t, e) {
    ...
    var t = "@@InfiniteScroll"
      ...
      , o = function() {
        if (!this.binded) {
            this.binded = !0;
            var t, e, i, r, o, a, u, l, c = this, h = c.el;
...
function(t, e) {
    ...
    , function(t, e, n) {
        var i = n(3)
          ...
          , s = "prototype"
          , a = function(t, e, n) {
            var u, l, c, h = t & a.F, f = t & a.G, d = t & a.S, p = t & a.P, m = t & a.B, g = t & a.W, v = f ? r : r[e] || (r[e] = {}), y = f ? i : d ? i[e] : (i[e] || {})[s];
            for (u in f && (n = e),
            n)
...
function(t, e) {
    ...
    var t, e, n = "lscache-", i = "-cacheexpiration", r = 6e4, o = w(r), s = "", a = !1;
    function u() {
    ...
    function g(t) {
        var e, r, o = new RegExp("^" + n + (s.replace(/[[\]{}()*+?.\\^$|]/g, "\\$&") + "(.*)")), a = [];
...
function(t, e) {
    ...
    function rt(t) {
        ...
        if ("static" !== function(t, e) {
            ...
            }, h = n.offsetWidth, f = n.offsetHeight, d = O(e), p = d.clientWidth, m = d.clientHeight, g = function(t, e) {
            ...
            }(e), b = g.left, w = g.top, S = g.width, _ = b - h - r < 0, $ = b + h + S + r >= p, T = w + f + r >= m, E = w + f + g.height + r >= m, C = w - f - r < 0, I = (!o && s || o && !s) && b + S - h < 0, A = (o && s || !o && !s) && b + h >= p;
